...
# hardware
parser.add_argument("--cuda",default=0, help="use GPU")
...
# data path
parser.add_argument("--imgGTRoot", default="/home/data/disk2/wsq/Datasets/DIV2K/DIV2K_train_HR/", type=str, help="Path of training GT images")
parser.add_argument("--imgValidRoot", default="/home/data/disk2/wsq/Datasets/DIV2K/DIV2K_valid_HR/", type=str, help="Path of validation images")

# training data
parser.add_argument("--dataloader", default="jpeg_qm", type=str, help="dataloader")
parser.add_argument("--batchSize", default=2, type=int, help="training batch size")
...
parser.add_argument("--savedir", default="/home/data/disk3/zl/code/QGCN-master/checkpoints", type=str, help="save checkpoint")
